...
@app.route('/hrsuite', methods=['GET', 'POST'])
def hrsuite():
    ...
    return render_template('hrsuite.html', result_filename=result_filename)

@app.route('/download_hrsuite/<filename>')
def download_hrsuite(filename):
    path = os.path.join(OUTPUT_FOLDER, filename)
    print(f"Download HR Suite richiesto per: {filename}")
